...
function OurTeam() {
    const teamMembers = [
        { img: require('../images/1.jpg'), name: 'Jane William', role: 'Spa Massage' },
        ...
        { img: require('../images/i2.jpg'), name: 'Mary Johnson', role: 'Spa Massage' },
                ...
                <aside className='team-left'>
                    <div className='sidebar-sticky'>
                        ...
                        <h2 className='team-title'>
                            Meet our experienced yoga and meditation experts
                        </h2>
